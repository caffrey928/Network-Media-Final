...
import { Verify } from "../util/payment";
...
const MainDialog = () => {
    ...
    const Loader = () => {
        return (
            <>
                <p style={{fontSize: "18px", textAlign:"center", marginBottom: "1rem"}}>Verifying...</p>
                <BarLoader
                    color="white"
                    loading={loading}
                    height={5}
    ...
    const MainPage = () => {
        return (
            <>
                ...
                <p className="dialog__text">Status: {loading ? <Loader/> : verified}</p>
    ...
    const TutorialPage = () => {
        return (
            <>
                <p className="tutorial__title">Step 1 : <br />  </p>
                ...
                <p className="tutorial__title">Step 2 : <br /></p>
                <p className="tutorial__text">Go to Holder, generate a presentation file with this challenge.</p>
                <p className="tutorial__title">Step 3 : <br /></p>
                <p className="tutorial__text">
                ...
                <p className="tutorial__title">Step 4 : <br /></p>
                <p className="tutorial__text">
